function extractRBC(folder,net)
    ...
    % extractRBC returns an ImageDatastore and a
    % PixelLabelDatastore of cropped and masked RBCs and the corresponding 
    % label patches.
    % Inputs:
            % 1. FOLDER
            % 2. Trained SNN for RBCs semantic segmentation.
